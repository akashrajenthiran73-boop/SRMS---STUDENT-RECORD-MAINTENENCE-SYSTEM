...
if (empty($SUPABASE_URL) || empty($SUPABASE_KEY)) {
    ...
    if($http >= 200 && $http < 300) {
        header("Location: umis_page3.php?student_id=" . urlencode($student_id)); 
        exit;
    } else { 
...
<title>UMIS Form - Page 2 - SRMS</title>
    ...
    <div class="content-body">
        <div class="box">
            <div class="form-header">
                <h2>
                    <span class="header-icon-wrap"><i class="fa-solid fa-address-book"></i></span>
                    UMIS Enrollment - Page 2 of 4
                </h2>
            ...
            <div class="stepper-container">
                ...
                <div class="step-item active"><i class="fa-solid fa-circle-check"></i> 2. Contact & Address</div>
                <div class="step-divider"></div>
            ...
            <form method="POST">
                <div class="section">
                    ...
                    <div class="row">
                        <div class="g"><label>22. Mobile Number</label><input type="text" name="mobile" value="<?=v('mobile')?>"></div>
                        <div class="g"><label>23. Email ID</label><input type="email" name="email" value="<?=v('email')?>"></div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="row">
                        <div class="g"><label>24. Country</label><input type="text" name="country" value="<?=v('country','India')?>"></div>
                        <div class="g"><label>25. State / UT</label><input type="text" name="state" value="<?=v('state','Tamil Nadu')?>"></div>
                        <div class="g"><label>26. Location Type</label>
                            <select name="location_type">
                                <option value="Rural" <?=(v('location_type')=='Rural')?'selected':''?>>Rural</option>
                                <option value="Urban" <?=(v('location_type')=='Urban')?'selected':''?>>Urban</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="g"><label>27. District</label><input type="text" name="district" value="<?=v('district')?>"></div>
                        <div class="g"><label>28. Taluk</label><input type="text" name="taluk" value="<?=v('taluk')?>"></div>
                        <div class="g"><label>29. Village</label><input type="text" name="village" value="<?=v('village')?>"></div>
                    </div>
                    <div class="row">
                        <div class="g"><label>30. Block</label><input type="text" name="block" value="<?=v('block')?>"></div>
                        <div class="g"><label>31. Village Panchayat</label><input type="text" name="village_panchayat" value="<?=v('village_panchayat')?>"></div>
                        <div class="g"><label>32. Pincode</label><input type="text" name="pincode" value="<?=v('pincode')?>"></div>
                    </div>
                    <div class="form-group" style="margin-top: 10px;">
                        <label>33. Postal Address</label>
                        <input type="text" name="postal_address" value="<?=v('postal_address')?>">
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="row">
                        <div class="g"><label>34. Country</label><input type="text" name="comm_country" value="<?=v('comm_country','India')?>"></div>
                        <div class="g"><label>35. State / UT</label><input type="text" name="comm_state" value="<?=v('comm_state','Tamil Nadu')?>"></div>
                        <div class="g"><label>36. Location Type</label>
                            <select name="comm_location_type">
                                <option value="Rural" <?=(v('comm_location_type')=='Rural')?'selected':''?>>Rural</option>
                                <option value="Urban" <?=(v('comm_location_type')=='Urban')?'selected':''?>>Urban</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="g"><label>37. District</label><input type="text" name="comm_district" value="<?=v('comm_district')?>"></div>
                        <div class="g"><label>38. Taluk</label><input type="text" name="comm_taluk" value="<?=v('comm_taluk')?>"></div>
                        <div class="g"><label>39. Village</label><input type="text" name="comm_village" value="<?=v('comm_village')?>"></div>
                    </div>
                    <div class="row">
                        <div class="g"><label>40. Block</label><input type="text" name="comm_block" value="<?=v('comm_block')?>"></div>
                        <div class="g"><label>41. Village Panchayat</label><input type="text" name="comm_village_panchayat" value="<?=v('comm_village_panchayat')?>"></div>
                        <div class="g"><label>42. Pincode</label><input type="text" name="comm_pincode" value="<?=v('comm_pincode')?>"></div>
                    </div>
                    <div class="form-group" style="margin-top: 10px;">
                        <label>43. Postal Address</label>
                        <input type="text" name="comm_postal_address" value="<?=v('comm_postal_address')?>">
                    </div>
                </div>

                <div class="nav-actions">
                    <a href="umis_page1.php?student_id=<?=urlencode($student_id)?>" class="back-btn"><i class="fa-solid fa-arrow-left"></i> Back to Page 1</a>
                    <button type="submit" name="save_page2">Save & Go to Page 3 <i class="fa-solid fa-arrow-right"></i></button>
                </div>
            </form>
        </div>
    </div>
