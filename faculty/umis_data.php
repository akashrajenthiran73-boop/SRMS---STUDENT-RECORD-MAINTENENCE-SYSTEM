...
<title>UMIS Management - Faculty Portal</title>
...
<div class="main-content">
    ...
    <div class="topbar">
        <h2><i class="fa-solid fa-clipboard-user"></i> UMIS Records Directory</h2>
    ...
    <div class="content-body">
        ...
        <div class="page-header">
            <div>
                <h1><i class="fa-solid fa-id-card" style="color: #2563EB;"></i> UMIS Student Records</h1>
                <p style="color: #64748B; font-size: 13.5px; margin-top: 4px;">Total UMIS Entries: <b><?php echo is_array($umis_list) ? count($umis_list) : 0; ?></b></p>
            </div>
            <div class="search-box">
                <i class="fa-solid fa-magnifying-glass"></i>
                <input type="text" id="searchInput" onkeyup="filterUmisTable()" placeholder="Search UMIS records...">
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        if(is_array($umis_list) && !empty($umis_list)): 
                            foreach($umis_list as $u): 
                                ...
                                $parent_phone = trim($u['parent_phone'] ?? '');
                        ?>
                        <tr>
                          <td><?=$i++?></td>
                          <td><span class="badge-tag" style="color: #2563EB; font-weight: 700;"><?=htmlspecialchars($stu_id)?></span></td>
                          <td style="font-weight: 700; color: #0F172A;"><?=htmlspecialchars($student_name)?></td>
                          ...
                          <td style="text-align: right; white-space: nowrap;">
                              <a href="view_umis.php?student_id=<?=urlencode($stu_id)?>" class="btn btn-view"><i class="fa-solid fa-eye"></i> View</a>
                        ...
                        ?>
                        <tr><td colspan="6" style="text-align:center; padding: 50px 20px; color: #64748B;">No UMIS Records Found</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
...
<script>
function filterUmisTable() {
    var input = document.getElementById("searchInput");
    var filter = input.value.toLowerCase();
    var table = document.getElementById("umisTable");
